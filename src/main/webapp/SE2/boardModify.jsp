		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="row">
				<div class="col-sm-8 blog-main">
					...
					<form action="${pageContext.request.contextPath }/boardDetailModify"
							method="post" id="frm" enctype="multipart/form-data">
					<div class="table-responsive">
						<label class="col-sm- control-label">제목 :</label>
						<input type="text" name="detail_title" value="${detailVo.detail_title }" ><br>
						<label class="control-label">작성자 : </label>
						<label class="control-label">${detailVo.userid }</label>
						
						<input type="hidden" name="userid" value="${detailVo.userid }">
						<input type="hidden" name="board_id" value="${detailVo.board_id }">
						<input type="hidden" name="detail_id" value="${detailVo.detail_id }">
							...
							<textarea name="detail_text" id="smarteditor" rows="10" class="inputSize"
								cols="100" style="width: 766px; height: 412px;" >${detailVo.detail_text}</textarea>
							...
							<div class="form-group">
								<label for="userNm" class="col-sm-2 control-label">첨부파일(누르면삭제)</label>
									<div id="fileAdd" class="col-sm-6" >
									<c:if test="${amentList != null }">
									<c:forEach items="${amentList }" var="ament" step="1">
									 <a class='file' href="${pageContext.request.contextPath }/deleteAment?ament_id=${ament.ament_id }&detail_id=${detailVo.detail_id}">${ament.ament_nm }</a><br>
									</c:forEach>
									</c:if>	
									</div>
								</div>
